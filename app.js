    ...
    const handleMove = (y) => {
        ...
        if (mapViewContainer) {
            ...
            if (mapInner) {
                ...
                // Clamp translate to prevent revealing edges (increased since map is now 150% height)
                const maxTranslate = 120; // max 120px movement in either direction (we have 25% buffer = ~150px at typical viewport)
