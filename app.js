            ...
            if (nextArrival.status === 'Active') {
                timeDisplayHtml = `
                    <div class="time-inline">
                        ...
                        <svg class="chevron" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="margin-left: 20px;">
